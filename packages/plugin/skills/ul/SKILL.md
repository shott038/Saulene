...
If the command produces no output, tell the user: "You don't have an ul yet. Run `/ul-setup` to create your companion — setup works right here in Claude Code, no separate terminal needed."
